...
powershell -ExecutionPolicy Bypass -File bin\ini-set.ps1 -filepath '%phprc_cli_server_ini_filepath%' -name 'open_basedir' -value '\"%project_dirpath%\"'
...
if not defined builtin_server_router_script set builtin_server_router_script=%builtin_server_document_root%\cli-server-router.php
...
cd %builtin_server_document_root%
