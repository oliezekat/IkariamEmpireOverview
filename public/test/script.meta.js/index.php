...
$userscript_meta_js_twig_filepath = $templates_dirpath . DIRECTORY_SEPARATOR . 'userscript' . DIRECTORY_SEPARATOR . 'test' . DIRECTORY_SEPARATOR . 'script.meta.js.twig';
$content = file_get_contents($userscript_meta_js_twig_filepath);
